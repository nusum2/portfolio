...
public class NaverLoginService {
	...
	public String getNaverAuthorizeUri() throws UnsupportedEncodingException {
	...
	public String getNaverTokenUrl(NaverCallback callback) throws Exception {
		
		try {
		
		
		//access token을 받기위한 요청 보내기 작업후 결과값이 json으로 응답
		UriComponents uriComponents = UriComponentsBuilder
